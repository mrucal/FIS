...
public class Pelicula {
    ...
    void vincularActor (Actor miActor){
        misActores.put(miActor.obtenerNombre(), miActor);
    }
    ...
    List<List> obtenerDatosBasicos(){
        ...
        aux.add(titulo);
        aux.add(Integer.toString(anioEstreno));
        ...
        for(String key: misDirectores.keySet()){
             nombreD=misDirectores.get(key).obtenerNombre();
        ...
        for(String key: misActores.keySet()){
             nombreA=misActores.get(key).obtenerNombre();
